...
Elements like [indices](indices.md#indices), [components](components.md#components) or [controllers](controllers.md#controllers)
...
When aggregating those elements into a [controller manager](manager.md#manager) the cluster names are also aggregated and mapped to logical clusters declared for the controller manager.

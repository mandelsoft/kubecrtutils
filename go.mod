module github.com/mandelsoft/kubecrtutils
...
require (
	...
	github.com/mandelsoft/spiff v1.3.0-beta-7.0.20251217160149-636218617943 // indirect
...
require github.com/mandelsoft/kubedns v0.0.0

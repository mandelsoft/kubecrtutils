...
func (w Predicates) ApplyToFor(opts *forOptions) {
	opts.predicates = w.predicates
}

// ApplyToOwns applies this configuration to the given ownsOptions options.
func (w Predicates) ApplyToOwns(opts *ownsOptions) {
	opts.predicates = w.predicates
}

// ApplyToWatches applies this configuration to the given watchesOptions options.
...
// ApplyToFor applies this configuration to the given ForInput options.
func (p projectAs) ApplyToFor(opts *forOptions) {
	opts.objectProjection = objectProjection(p)
}

// ApplyToOwns applies this configuration to the given ownsOptions options.
func (p projectAs) ApplyToOwns(opts *ownsOptions) {
	opts.objectProjection = objectProjection(p)
}
...
// ApplyToOwns applies this configuration to the given ownsOptions options.
func (o matchEveryOwner) ApplyToOwns(opts *ownsOptions) {
